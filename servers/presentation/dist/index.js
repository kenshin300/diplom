...
import { slide1Cover, slide2Task, slide3Solution, slide4WhyUs, slide5Cases, slide6About, slide7Contacts, } from "./slides.js";
...
server.registerTool("generate_presentation", {
    description: "Generate a PPTX pitch deck using data gathered from order-parser and research servers. " +
    ...
    const imageItems = await Promise.all(pngFiles.map(async (f) => {
